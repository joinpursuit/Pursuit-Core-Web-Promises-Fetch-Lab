...
const revealAnswer = () => {
    ...
    if(document.querySelector("div").class === "closed"){
    document.querySelector("div").innerText += answer;
    document.querySelector("div").class = "opened"
    } else {
        document.querySelector("div").innerText = jokeObject.setup;
        document.querySelector("div").class = "closed"
    }
}